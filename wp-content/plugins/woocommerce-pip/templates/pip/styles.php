...
<style type="text/css">
	...
	<?php // TODO WC 3.0 throws a PHP notice with these nested pseudo selectors due to an outdated Emogrifier class, this might change in the near future {FN 2017-03-28} ?>
	<?php // issue @link https://github.com/woocommerce/woocommerce/issues/13788 ?>
	<?php if ( SV_WC_Plugin_Compatibility::is_wc_version_lt_3_0() ) : ?>
		/* Separator doesn't apply on last document or individual documents */
		body > div.container:last-child:after {
			display: none;
		}
	<?php endif;?>
