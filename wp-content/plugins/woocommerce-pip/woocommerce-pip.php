...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.6.0', __( 'WooCommerce Print Invoices/Packing Lists', 'woocommerce-pip' ), __FILE__, 'init_woocommerce_pip', array(
