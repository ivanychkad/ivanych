 ...
 */
add_filter( 'template_include', array( 'Chefplaza_Wrapping', 'wrap' ), 99 );
add_filter( 'chefplaza_wrap_base', 'chefplaza_wrap_base_cpts' );
 ...
 */
function chefplaza_template_path() {
	return Chefplaza_Wrapping::$main_template;
}
 ...
 */
function chefplaza_template_base() {
	return Chefplaza_Wrapping::$base;
}

if ( ! class_exists( 'Chefplaza_Wrapping' ) ) {
	...
	class Chefplaza_Wrapping {
		...
		/**
		 * Initialize new instance of Chefplaza_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'chefplaza_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Chefplaza_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function chefplaza_wrap_base_cpts( $templates ) {
