...
if ( ! class_exists( 'Chefplaza_Widget_Area' ) ) {

	class Chefplaza_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'chefplaza_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'chefplaza_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'chefplaza_widget_area_classes', $classes, $area_id );
	...
	function chefplaza_widget_area() {
		return Chefplaza_Widget_Area::get_instance();
	}

	chefplaza_widget_area();
}
