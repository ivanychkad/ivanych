 ...
 * @return void
 */
function chefplaza_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon material-icons">subject</i>
		</button>
		<?php
		$args = apply_filters( 'chefplaza_main_menu_args', array(
			'theme_location'   => 'main',
			'container'        => '',
			'menu_id'          => 'main-menu',
			'fallback_cb'      => 'chefplaza_set_nav_menu',
			'fallback_message' => esc_html__( 'Set main menu', 'chefplaza' ),
		) );
 ...
 * @return void
 */
function chefplaza_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
		<?php
		$args = apply_filters( 'chefplaza_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'chefplaza' ),
		) );
 ...
 * @return string
 */
function chefplaza_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance ++;
	...
	$args = apply_filters( 'chefplaza_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'chefplaza_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'chefplaza' ),
	), $context, $type );
 ...
 * @return void
 */
function chefplaza_set_nav_menu( $args ) {
