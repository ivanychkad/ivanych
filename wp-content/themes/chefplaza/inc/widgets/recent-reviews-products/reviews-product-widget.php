...
class Chefplaza_WC_Widget_Recent_Reviews extends WC_Widget_Recent_Reviews {
	/**
	 * Output widget.
	 *
	 * @see WP_Widget
	...
	public function widget( $args, $instance ) {
		...
		if ( $comments ) {
			...
			foreach ( (array) $comments as $comment ) {
				...
				printf( '<em class="reviewer">' . _x( 'by <span>%1$s</span>', 'by comment author', 'chefplaza' ) . '</em>', get_comment_author() );
