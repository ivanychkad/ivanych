<?php
/**
 * About Chefplaza widget.
 *
 * @package Chefplaza
 */

if ( ! class_exists( 'Chefplaza_About_Widget' ) ) {

	class Chefplaza_About_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an information about your site.', 'chefplaza' );
			$this->widget_id          = 'chefplaza_widget_about';
			$this->widget_name        = esc_html__( 'About Chefplaza', 'chefplaza' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'multi_upload'       => false,
					'library_type'       => 'image',
					'upload_button_text' => esc_html__( 'Upload', 'chefplaza' ),
					'value'              => '',
					'label'              => esc_html__( 'Logo:', 'chefplaza' ),
				),
				'enable_tagline' => array(
					...
					'options' => array(
						'enable_tagline' => esc_html__( 'Enable Tagline:', 'chefplaza' ),
					),
				),
				'content'  => array(
					'type'              => 'textarea',
					'placeholder'       => esc_html__( 'Text or HTML', 'chefplaza' ),
					'value'             => '',
					'label'             => esc_html__( 'Content:', 'chefplaza' ),
		...
		public function widget( $args, $instance ) {
			...
			if ( $tagline_enabled ) {
				$format   = apply_filters( 'chefplaza_about_widget_tagline_format', '<p>%s</p>', $this->settings, $this->args );
...
add_action( 'widgets_init', 'chefplaza_register_about_widget' );
function chefplaza_register_about_widget() {
	register_widget( 'Chefplaza_About_Widget' );
}
