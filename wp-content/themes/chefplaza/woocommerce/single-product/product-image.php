...
if ( has_post_thumbnail() ) {
	...
	wp_enqueue_script( 'jssor-init', CHEFPLAZA_THEME_URI . '/assets/js/single_product.js', array( 'jquery-jssor' ), '1.0.0', true );
	...
	echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), esc_html__( 'Placeholder', 'chefplaza' ) ), $post->ID );
}
?>